...
const serverEntryPath = path.resolve(currentDirectory, 'dist/server/server.js')
...
app.use((error: unknown, _req: ExpressRequest, res: ExpressResponse, _next: express.NextFunction) => {
