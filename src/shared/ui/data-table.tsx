                ...
                {showColumnToggle && (
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="outline" size="sm" className="ml-auto w-full sm:w-auto border-border/40 hover:bg-accent/60 transition-colors">
                            ...
                            {table.getHeaderGroups().map((headerGroup) => (
                                <tr key={headerGroup.id}>
                                    {headerGroup.headers.map((header) => {
                                        return (
                                            <th key={header.id} className="px-5 py-3.5 font-semibold whitespace-nowrap align-top">
                                                {header.isPlaceholder ? null : (
                                                    <div className="space-y-2">
                                                        ...
                                                        >
                                                            ...
                                                            {header.column.getCanSort() && (
                                                                <span className="text-muted-foreground/40">
                                                                    {{
                                                                        asc: <ChevronUp className="size-3.5 text-primary" />,
                                                                        desc: <ChevronDown className="size-3.5 text-primary" />,
                                                        ...
                                                        {header.column.columnDef.header !== 'Estado' && header.column.getCanFilter() ? (
                                                            <div>
                                                                <Input
                                                                    placeholder={`Filtrar...`}
                                                        ...
                                                        ) : null}
                                                        {
                                                            header.column.columnDef.header === 'Estado' && (
                                                                <>
                                                                    {<StatusFilter key={header.id} column={header.column} />}
                                                                </>
                                                            )
                                                        }
                                                    </div>
