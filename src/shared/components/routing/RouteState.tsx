    ...
    <div className="flex min-h-[60vh] items-center justify-center p-6">
      <Card className="w-full max-w-xl glass-card border-border/40 shadow-lg overflow-hidden relative animate-fade-up">
        ...
        <CardHeader className="relative text-center">
          ...
          <CardTitle className="text-xl font-display">No se encontró la página</CardTitle>
...
export function RouteErrorState({ error, scope = "este módulo" }: RouteErrorProps) {
    ...
    <div className="flex min-h-[60vh] items-center justify-center p-6">
      <Card className="w-full max-w-xl glass-card border-destructive/20 shadow-lg overflow-hidden relative animate-fade-up">
        ...
        <CardHeader className="relative text-center">
          ...
          <CardTitle className="text-xl font-display">Error al cargar la ruta</CardTitle>
          <CardDescription className="mt-1">
            Se produjo un problema al renderizar {scope}. Puedes volver al dashboard.
          </CardDescription>
        </CardHeader>
        <CardContent className="relative space-y-4 pb-6">
          <p className="rounded-xl bg-muted/60 border border-border/40 p-3 text-sm text-muted-foreground font-mono">{message}</p>
