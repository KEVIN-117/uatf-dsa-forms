  ...
  for (let i = 1; i <= 200; i++) {
    ...
    if (isStudent) {
      responses.push({
        ...
        createdAt,
        response: {
          modalidad: mockModalities[Math.floor(Math.random() * mockModalities.length)],
          masculino,
          femenino,
          total,
        },
      ...
      const surnames = ["García", "López", "Mamani", "Quispe", "Fernández", "Condori", "Vargas", "Rojas"];
      const names = ["Juan", "María", "Carlos", "Ana", "Pedro", "Luisa", "José", "Rosa"];
      responses.push({
        id: `mock-resp-${i}`,
        templateId: "9",
        ...
        response: {
          ...
          profesion: ["Ing. Sistemas", "Lic. Matemáticas", "Ing. Civil", "Lic. Física"][Math.floor(Math.random() * 4)],
        },
      });
    } else {
      responses.push({
        ...
        createdAt,
        response: {
          tipo: mockScholarshipTypes[Math.floor(Math.random() * mockScholarshipTypes.length)],
          masculino,
          femenino,
          total,
        },
