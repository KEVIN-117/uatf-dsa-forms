...
export function StuNumPassFailDrop() {
    return (
            ...
            <Card className="w-full max-w-md shadow-lg border-border">
                <CardHeader className="space-y-2">
                    <CardTitle className="text-2xl text-center font-display text-primary">
                        Número de estudiantes aprobados, reprobados y desertores
                    </CardTitle>
                    <CardDescription className="text-center font-body text-muted-foreground">
                        Este es el formulario de número de estudiantes aprobados, reprobados y desertores
                    </CardDescription>
                </CardHeader>
