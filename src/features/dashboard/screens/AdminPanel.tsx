...
import { Building2, GraduationCap, DoorOpen, Award, Users, ArrowRight, Settings } from "lucide-react"
                    ...
                    >
                        ...
                        `}>
                            ...
                            <CardHeader className="relative flex flex-row items-center gap-4 space-y-0">
                                <div className={`flex size-12 items-center justify-center rounded-xl ${link.iconBg} group-hover:scale-110 transition-transform duration-300 shrink-0`}>
