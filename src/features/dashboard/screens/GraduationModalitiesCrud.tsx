	...
	return (
		<div className="p-6 space-y-6 max-w-8xl mx-auto">
			...
			<EntityFormSheet
				...
				description={editing ? "Modifica los datos" : "Ingresa los datos"}
				open={sheetOpen}
				onOpenChange={setSheetOpen}
			>
				<form onSubmit={handleSubmit} className="space-y-4">
					<div className="space-y-2">
						<Label htmlFor="gm-id">ID</Label>
						<Input
							id="gm-id"
							value={form.id}
					...
					<div className="space-y-2">
						<Label htmlFor="gm-name">Nombre</Label>
						<Input
							id="gm-name"
							value={form.name}
					...
					<div className="space-y-2">
						<Label htmlFor="gm-code">Código</Label>
						<Input
							id="gm-code"
							value={form.code}
