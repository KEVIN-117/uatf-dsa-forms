...
export const Route = createFileRoute('/dashboard/form-builder')({
  ...
  notFoundComponent: () => <RouteNotFoundState scope="constructor de formularios" />,
  errorComponent: ({ error }) => <RouteErrorState error={error} scope="constructor de formularios" />,
});
