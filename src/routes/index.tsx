      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              to="/speakers"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-linear-to-r from-copper to-copper-dark text-charcoal font-semibold text-lg transition-all hover:shadow-lg hover:shadow-copper/30 hover:scale-[1.02] bg-accent/50 backdrop-blur-sm p-4"
            >
            ...
            <Link
              to="/talks"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full border-2 border-gold/50 text-gold font-semibold text-lg transition-all hover:bg-gold/10 hover:border-gold bg-accent/20 backdrop-blur-sm p-4"
            >
              View Sessions
